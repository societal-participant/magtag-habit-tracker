...
<p>To install the habit tracker, download the following project files and save them to the root of your <code>CIRCUITPY</code> device:</p>
<ul>
<li><code>code.py</code></li>
<li><code>secrets.py</code></li>
</ul>
...
<p>The habit tracker is configured by editing the values in <code>code.py</code>.</p>
...
<p>The default time zone used is UTC. The numerical representation of your time zone is needed. To find your time zone, go to:<br>
...
<p>If the time zone is west of UTC, add a minus sign before the number.</p>
